...
function getAllDirectors(moviesArray) {moviesArray.map(function(movie){return movie.director}
)};
...
function dramaMoviesScore(moviesArray) {
    ...
    const totalDramaScore = dramaMovies.reduce(function(acc, movie) {
      return acc + movie.score;
    }, 0);
...
///5-6 important should return new array Mep use 
...
function orderAlphabetically(moviesArray) {
    ...
    const first20Titles = sortedMovies.slice(0, 20).map(function(movie) {
      return movie.title;
    });
